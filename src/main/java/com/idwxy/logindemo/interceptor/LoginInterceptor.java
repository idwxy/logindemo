package com.idwxy.logindemo.interceptor;
...
public class LoginInterceptor implements HandlerInterceptor {
        ...
        try {
            ...
            if (user != null) {
                ...
                if (!token.equals(preToken)) {
                    ...
                    return false;
                 // step 4  至此登录成功，查看 token 过期时间是否小于1分钟, 返回值单位毫秒，故 * 1000比较
                } else {
    ...
    public void render(HttpServletResponse response, String msg) throws IOException {
        ResultObject resultObject = new ResultObject(406, msg, null);
